...
const Navbar = () => {
    ...
    const toggleTheme = () => {
        console.log("toggle theme fun run")
    ...
    return (
        <div className={`max-w-screen-2xl container mx-auto md:px-6 sm:px-4 fixed top-0 left-0 right-0 z-50 dark:bg-slate-900 dark:text-white${sticky ?
            "dark:bg-slate-900 dark:text-white sticky-navbar shadow-md bg-base-200 duration-300 transition-all ease-in-out"
            : ""}`}>
